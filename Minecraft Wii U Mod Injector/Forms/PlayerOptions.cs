...
namespace Minecraft_Wii_U_Mod_Injector.Forms {
    public partial class PlayerOptions : MetroForm {
        ...
        private void Init(object sender, EventArgs e) {
            ...
            Console.WriteLine($"LocalPlayer: 0x{_localPlayer:X4}");
        }
        ...
        private void OpenScoreboardBtnClicked(object sender, EventArgs e) {
            MainForm.GeckoU.CallFunction(0x031A09A8, _localPlayer, 0x1);
        }

        private void GameModeBoxChanged(object sender, EventArgs e) {
            // Write the gamemode values to free memory space so we can pass them through RPC
